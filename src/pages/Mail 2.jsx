  ...
  return (
    <>
      <PageHeader
        ...
        title="Brixlift Mail"
        description="Open Hostinger Webmail for company mailboxes and keep the setup details handy for employee devices."
      ...
      <Grid container spacing={2.5}>
            ...
            <Stack spacing={2}>
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: "text.secondary", mt: 0.75 }}>
                  Employees can sign in with their own mailbox, for example name@brixlift.com.
                </Typography>
              </Box>
        ...
        <Grid size={{ xs: 12, lg: 7 }}>
          <SectionCard
            ...
            action={<Chip icon={<SettingsRoundedIcon />} label="Hostinger Email" variant="outlined" />}
          >
            <Box
              sx={{
                display: "grid",
